...
def setting_args(cfg: DictConfig):
    model_args = ModelArguments(
        model_name_or_path=cfg["model"]["model_name_or_path"]
    )
    data_args = DataArguments(
        eval_dataset_size=cfg["data"]["eval_dataset_size"],
        max_eval_samples=cfg["data"]["max_eval_samples"],
        source_max_len=cfg["data"]["source_max_len"],
        target_max_len=cfg["data"]["target_max_len"],
    ...
    training_args = TrainingArguments(
        ...
        do_train=cfg["trainer"]["do_train"],
        do_eval=cfg["trainer"]["do_eval"],
        bf16=cfg["trainer"]["bf16"],
        bits=cfg["trainer"]["bits"],
